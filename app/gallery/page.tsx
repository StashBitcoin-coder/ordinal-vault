        ...
        <div style={{
          ...
          <input
            ...
            style={{
              ...
              borderRadius: 7, padding: '0.6rem 1rem',
          ...
          <select
            ...
            style={{
              background: 'var(--bg3)', border: '1px solid var(--border)',
              borderRadius: 7, padding: '0.6rem 0.9rem',
              color: 'var(--text)', fontFamily: "'Space Mono', monospace",
    ...
    >
      ...
      >
        ...
        <div style={{ padding: '1.5rem' }}>
          ...
          {/* Verify */}
          <a
            href={ordinalsUrl} target="_blank" rel="noopener noreferrer"
            style={{
  ...
  return (
    <div style={{
      ...
      <span style={{
        ...
        color: 'var(--text)',
        wordBreak: brk ? 'break-all' : 'normal',
      }}>
        {value}
      </span>
    </div>
